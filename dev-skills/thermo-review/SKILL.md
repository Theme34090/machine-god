...
3. Launch both subagents in the same message:
    - `thermo-nuclear-review-subagent` for bugs, breakages, security, devex regressions, feature-flag leaks, and other branch-audit risks. tell it to look at `references/thermo-nuclear-review.md` for review guideline.
    - `thermo-nuclear-code-quality-review-subagent` for maintainability, structure, file-size growth, spaghetti, abstractions, and codebase-health risks. tell it to look at `references/thermo-nuclear-code-quality-review.md` for review guideline.
